...
let obj = {name: "raj",Rno:17}; // Object
...
let Var1 = "old";
console.log(Var1); // Output: old
Var1 = "New";
console.log(Var1); // Output: New 
// Activity 5: Understanding `const`
// Task 6: Try reassigning a variable declared with `const` and observe the error.
const constant = "Const";
console.log(constant); // Output: Constant Value
